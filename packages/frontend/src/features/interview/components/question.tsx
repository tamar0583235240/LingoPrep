...
const Question: React.FC<QuestionProps> = ({
  ...
  const { questions, currentIndex, currentUserId } = useSelector(
    ...
    <div className="bg-transparent">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <div className="bg-white rounded-2xl shadow-md border border-[--color-border] p-4 max-w-xl w-full text-right">
          ...
          <div className="text-xl mb-6 leading-snug">{currentQuestion.content}</div>
                ...
                onUploaded={async (fileUrl, fileName) => {
                  try {
                    ...
                    setNotification({
                      ...
                      type: "success",
                      icon: (
                        <CheckCircle2 className="w-6 h-6 text-[--color-primary-dark]" />
                      ),
                    });
